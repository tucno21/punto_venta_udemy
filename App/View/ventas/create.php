            ...
            <div class="row align-items-center">
                <div class="col d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Nueva Venta</h5>
                    </div>
                    <div class="">
                        <a href="<?= route('ventas.index') ?>" class="btn btn-dark btn-sm">Volver</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header p-2">
                    ...
                    <p class="d-none" id="linkPdf" data-link="<?= route('ventas.pdfVenta') ?>"></p>
                    <p class="d-none" id="cantProducto" data-link="<?= route('ventas.cantProducto') ?>"></p>
                </div>
                <div class="card-body py-2">
                    ...
                    <form action="<?= route('ventas.create') ?>" method="POST" id="formVentas">
                        <?= csrf() ?>
